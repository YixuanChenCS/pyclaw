...
from pyclaw.io import AutoCompleter, ConfirmGroup, InputOutput
from pyclaw.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_color_initialization(self):
        ...
        with (
            patch("pyclaw.io.is_dumb_terminal", return_value=False),
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("pyclaw.io.open", side_effect=IsADirectoryError):
...
class TestInputOutputMultilineMode(unittest.TestCase):
    ...
    def test_ensure_hash_prefix(self):
        ...
        from pyclaw.io import ensure_hash_prefix
