...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from pyclaw.models import MODEL_SETTINGS
    ...
    @patch("pyclaw.models.check_for_dependencies")
    ...
    @patch("pyclaw.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from pyclaw.models import check_for_dependencies
    ...
    def test_pyclaw_extra_model_settings(self):
        import tempfile
    ...
    @patch("pyclaw.models.litellm.completion")
