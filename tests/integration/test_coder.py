...
from pyclaw.coders.base_coder import FinishReasonLength, UnknownEditFormat
...
from pyclaw.sendchat import sanity_check_messages
...
"""
    ...
    def test_skip_pyclawignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
            ...
            aignore = Path(".pyclawignore")
            aignore.write_text(f"{fname1}\n{fname2}\ndir\n")
            repo = GitRepo(
                io,
                fnames,
                None,
                pyclaw_ignore_file=str(aignore),
            )
...
This command will print 'Hello, World!' to the console."""
    ...
    def test_normalize_language(self):
        ...
        with patch("pyclaw.coders.base_coder.Locale", None):
        ...
        with patch("pyclaw.coders.base_coder.Locale", mock_babel_locale):
        ...
        with patch("pyclaw.coders.base_coder.Locale", mock_babel_locale_error):
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("pyclaw.coders.architect_coder.AskCoder.__init__", return_value=None):
                from pyclaw.coders.architect_coder import ArchitectCoder
                ...
                with patch("pyclaw.coders.architect_coder.Coder.create", return_value=mock_editor):
