...
from pyclaw.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_add_bad_glob(self):
        # https://github.com/Pyclaw-AI/pyclaw/issues/293
    ...
    def test_cmd_add_from_subdir_again(self):
        with GitTemporaryDirectory():
            ...
            # https://github.com/Pyclaw-AI/pyclaw/issues/201
    ...
    def test_cmd_add_from_outside_root(self):
        with ChdirTemporaryDirectory() as tmp_dname:
            ...
            # https://github.com/Pyclaw-AI/pyclaw/issues/178
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.pyclaw_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_pyclawignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
    ...
    def test_cmd_model_preserves_explicit_edit_format(self):
        ...
        with mock.patch("pyclaw.models.sanity_check_models"):
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("pyclaw.coders.Coder.run") as mock_run:
