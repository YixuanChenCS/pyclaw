...
def main():
    ...
    from pyclaw import __version__ as current_version
    ...
    with open("pyclaw/__init__.py", "r") as f:
        content = f.read()
    updated_content = re.sub(r'__version__ = ".+?"', f'__version__ = "{new_version}"', content)

    print("Updating pyclaw/__init__.py with new version:")
    print(updated_content)
    if not dry_run:
        with open("pyclaw/__init__.py", "w") as f:
            f.write(updated_content)

    git_commands = [
        ["git", "add", "pyclaw/__init__.py"],
    ...
    print()
    print("Updating pyclaw/__init__.py with new dev version:")
    ...
    # Remove pyclaw/_version.py if it exists
    version_file = "pyclaw/_version.py"
