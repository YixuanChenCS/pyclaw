...
# Badge tooltip texts
GITHUB_STARS_TOOLTIP = "Total number of GitHub stars the Pyclaw project has received"
PYPI_DOWNLOADS_TOOLTIP = "Total number of installations via pip from PyPI"
TOKENS_WEEKLY_TOOLTIP = "Number of tokens processed weekly by Pyclaw users"
OPENROUTER_TOOLTIP = "Pyclaw's ranking among applications on the OpenRouter platform"
SINGULARITY_TOOLTIP = "Percentage of the new code in Pyclaw's last release written by Pyclaw itself"

# Cache settings
CACHE_DIR = os.path.expanduser("~/.cache/pyclaw-badges")
...
def get_downloads_from_bigquery(credentials_path=None, package_name="pyclaw"):
    """
...
def get_total_downloads(
    api_key=None, package_name="pyclaw", use_bigquery=False, credentials_path=None
):
    """
...
def get_github_stars(repo="paul-gauthier/pyclaw"):
    """
...
def get_latest_release_pyclaw_percentage():
    """
    Get the percentage of code written by Pyclaw in the LATEST release
    ...
    try:
        ...
        if latest_release:
            percentage = latest_release.get("pyclaw_percentage", 0)
...
def generate_badges_md(downloads, stars, pyclaw_percentage):
    """
    ...
    # Round pyclaw percentage to whole number
    pyclaw_percent_rounded = round(pyclaw_percentage)

    markdown = f"""  <a href="https://github.com/Pyclaw-AI/pyclaw/stargazers"><img alt="GitHub Stars" title="{GITHUB_STARS_TOOLTIP}"
src="https://img.shields.io/github/stars/Pyclaw-AI/pyclaw?style=flat-square&logo=github&color=f1c40f&labelColor=555555"/></a>
  <a href="https://pypi.org/project/pyclaw/"><img alt="PyPI Downloads" title="{PYPI_DOWNLOADS_TOOLTIP}"
...
src="https://img.shields.io/badge/🏆%20OpenRouter-Top%2020-9b59b6?style=flat-square&labelColor=555555"/></a>
  <a href="https://pyclaw.chat/HISTORY.html"><img alt="Singularity" title="{SINGULARITY_TOOLTIP}"
src="https://img.shields.io/badge/🔄%20Singularity-{pyclaw_percent_rounded}%25-e74c3c?style=flat-square&labelColor=555555"/></a>"""  # noqa
...
def get_badges_md():
    ...
    total_downloads = get_total_downloads(api_key, "pyclaw", use_bigquery, credentials_path)

    # Get GitHub stars for the default repo
    stars = get_github_stars("paul-gauthier/pyclaw")

    # Get Pyclaw contribution percentage in latest release
    percentage, _ = get_latest_release_pyclaw_percentage()
...
def get_badges_html():
    ...
    pyclaw_percent_rounded = round(percentage)

    # Generate HTML badges
    html = f"""<a href="https://github.com/Pyclaw-AI/pyclaw" class="github-badge badge-stars" title="{GITHUB_STARS_TOOLTIP}">
    <span class="badge-label">⭐ GitHub Stars</span>
    <span class="badge-value">{stars_formatted}</span>
</a>
<a href="https://pypi.org/project/pyclaw/" class="github-badge badge-installs" title="{PYPI_DOWNLOADS_TOOLTIP}">
...
<a href="/HISTORY.html" class="github-badge badge-coded" title="{SINGULARITY_TOOLTIP}">
    ...
    <span class="badge-value">{pyclaw_percent_rounded}%</span>
</a>"""  # noqa
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Get total downloads and GitHub stars for pyclaw")
    parser.add_argument(
        "--api-key",
        help=(
    ...
    parser.add_argument(
        "--package", default="pyclaw", help="Package name (default: pyclaw)"
    )
    parser.add_argument(
        "--github-repo",
        default="paul-gauthier/pyclaw",
        help="GitHub repository (default: paul-gauthier/pyclaw)",
    )
    ...
    # Get Pyclaw contribution percentage in latest release
    percentage, version = get_latest_release_pyclaw_percentage()
    print(f"Pyclaw wrote {percentage:.2f}% of code in the LATEST release ({version})")
