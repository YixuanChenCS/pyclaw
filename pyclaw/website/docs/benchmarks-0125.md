...
[![benchmark results](/assets/benchmarks-0125.svg)](https://pyclaw.chat/assets/benchmarks-0125.svg)
...
pyclaw's existing
[lazy coding benchmark](https://pyclaw.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://pyclaw.chat/docs/unified-diffs.html) code editing format.
- Using pyclaw's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://pyclaw.chat/docs/benchmarks-1106.html).
- [Pyclaw's lazy coding benchmark](https://pyclaw.chat/docs/unified-diffs.html).
