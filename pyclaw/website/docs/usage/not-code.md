...
parent: Usage
nav_order: 901
description: Use pyclaw to edit configuration files, documentation, and other text-based formats.
---


# Editing config & text files

Pyclaw isn't just for code, it can be very helpful when editing
almost any text file.
You can use pyclaw to make changes to your shell & ssh settings, 
Dockerfiles
...
<div class="chat-transcript" markdown="1">
$ pyclaw Dockerfile docker-compose.yml
...
<div class="chat-transcript" markdown="1">
$ pyclaw /etc/hosts  # May need sudo
