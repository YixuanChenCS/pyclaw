...
Pyclaw lets you specify API keys in a few ways:

- On the command line
- As environment variables
- In a `.env` file
- In your `.pyclaw.conf.yml` config file

---

## OpenAI and Anthropic

Pyclaw has special support for providing
...
[YAML config file](/docs/config/pyclaw_conf.html), like this:
...
[`.pyclaw.conf.yml` file](/docs/config/pyclaw_conf.html)
