...
description: Follow along as pyclaw is modified to preserve read-only files specified at launch when using the /drop command. Pyclaw does this implementation and adds test coverage.
---
...
- 0:20 Let's explain the needed change to pyclaw.
...
- 2:19 Let's ask pyclaw to add tests for this.
