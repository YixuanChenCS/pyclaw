...
description: See how a new command-line option is added to automatically accept edits proposed by the architect model, with implementation. Pyclaw also updates the project's HISTORY file.
---
...
- 0:40 Pyclaw figured out that it should be passed to the Coder class.
...
- 1:42 That worked too. Let's have pyclaw update the HISTORY file to document the new feature.
