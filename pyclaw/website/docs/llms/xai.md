...
Start working with pyclaw and xAI on your codebase:
...
# Grok 3
pyclaw --model xai/grok-3-beta

# Grok 3 fast (faster, more expensive)
pyclaw --model xai/grok-3-fast-beta

# Grok 3 Mini
pyclaw --model xai/grok-3-mini-beta

# Grok 3 Mini fast (faster, more expensive)
pyclaw --model xai/grok-3-mini-fast-beta

# List models available from xAI
pyclaw --list-models xai/
```
...
```bash
pyclaw --model xai/grok-3-mini-beta --reasoning-effort high
```
