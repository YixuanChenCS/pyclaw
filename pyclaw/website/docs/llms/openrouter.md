...
Pyclaw can connect to [models provided by OpenRouter](https://openrouter.ai/models?o=top-weekly):
...
Start working with pyclaw and OpenRouter on your codebase:
...
pyclaw --model openrouter/<provider>/<model>

# List models available from OpenRouter
pyclaw --list-models openrouter/
```

In particular, many pyclaw users access Sonnet via OpenRouter:
...
2. By configuring "provider routing" in a `.pyclaw.model.settings.yml` file.
...
See [Advanced model settings](https://pyclaw.chat/docs/config/adv-model-settings.html#model-settings)
