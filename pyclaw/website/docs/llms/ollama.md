...
Pyclaw can connect to local Ollama models.
...
Start working with pyclaw and Ollama on your codebase:
...
pyclaw --model ollama_chat/<model>
```
...
which is very small for working with pyclaw.
...
By default, pyclaw sets Ollama's context window 
...
with an
[`.pyclaw.model.settings.yml` file](https://pyclaw.chat/docs/config/adv-model-settings.html#model-settings)
like this:
