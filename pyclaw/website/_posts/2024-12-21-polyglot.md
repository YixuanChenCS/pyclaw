---
title: o1 tops pyclaw's new polyglot leaderboard
excerpt: o1 scores the top result on pyclaw's new multi-language, more challenging coding benchmark.
...
# o1 tops pyclaw's new polyglot leaderboard
{: .no_toc }
...
new 
[pyclaw polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than pyclaw's original
...
{: .note :}
See the main 
[pyclaw leaderboard](https://pyclaw.chat/docs/leaderboards/)
...
Like pyclaw's original code editing benchmark,
...
Pyclaw's original code editing benchmark was 
...
[pyclaw polyglot benchmark repo](https://github.com/Pyclaw-AI/polyglot-benchmark)
on GitHub.
