---
title: o1-preview is SOTA on the pyclaw leaderboard
...
# OpenAI o1-preview is SOTA on the pyclaw leaderboard
...
OpenAI o1-preview scored 79.7% on pyclaw's code editing benchmark,
...
It is much more practical to use pyclaw's
...
The o1-preview model had trouble conforming to pyclaw's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
Pyclaw is extremely permissive and tries hard to accept anything close
...
It seems likely that pyclaw could optimize its prompts and edit formats to
better harness the o1 models.


## Using pyclaw with o1

OpenAI's new o1 models are supported in v0.57.0 of pyclaw:
...
> based on pyclaw v0.56.1-dev.
> See the [pyclaw leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest pyclaw releases.
