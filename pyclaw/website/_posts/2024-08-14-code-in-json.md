...
> Figure 1: Pyclaw coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why pyclaw uses a plain text format for LLMs to specify code edits (below),
...
Previous [pyclaw benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[pyclaw "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
pyclaw's "whole" edit format, where the
...
#### Notes on the pyclaw leaderboard

*The results presented here are not directly comparable to results
from the main
[pyclaw LLM leaderboard](https://pyclaw.chat/docs/leaderboards/).
