...
excerpt: Sonnet's score on the pyclaw code editing benchmark has been stable since it launched.
...
[pyclaw code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to pyclaw's system prompts.
...
> The 
> [pyclaw LLM code editing leaderboard](https://pyclaw.chat/docs/leaderboards/)
