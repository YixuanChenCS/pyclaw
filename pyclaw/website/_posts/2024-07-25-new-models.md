...
[pyclaw's code editing leaderboard](https://pyclaw.chat/docs/leaderboards/)
...
You can code with all of these models using pyclaw like this:
...
$ pyclaw --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ pyclaw --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ pyclaw --model openrouter/meta-llama/llama-3.1-405b-instruct
$ pyclaw --model openrouter/meta-llama/llama-3.1-70b-instruct
$ pyclaw --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://pyclaw.chat/docs/install.html)
and other
[documentation](https://pyclaw.chat/docs/usage.html)
for more details.
...
secured #7 on pyclaw's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on pyclaw's code editing
benchmark. 
