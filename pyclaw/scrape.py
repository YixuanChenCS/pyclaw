...
from pyclaw import __version__, urls, utils
from pyclaw.dump import dump  # noqa: F401

pyclaw_user_agent = f"Pyclaw/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["pyclaw[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({pyclaw_user_agent})"}
        try:
            with httpx.Client(
