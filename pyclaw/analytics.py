...
from pyclaw.models import model_info_manager
...
class Analytics:
    ...
    def get_data_file_path(self):
        try:
            data_file = Path.home() / ".pyclaw" / "analytics.json"
    ...
    def posthog_error(self, *_args, **_kwargs):
        """Disable PostHog if the client reports an upload error."""
        # https://github.com/PostHog/posthog-python/blob/9e1bb8c58afaa229da24c4fb576c08bb88a75752/posthog/consumer.py#L86
        # https://github.com/Pyclaw-AI/pyclaw/issues/2532
        self.ph = None
