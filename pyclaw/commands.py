...
from pyclaw import models, prompts, voice
from pyclaw.editor import pipe_editor
from pyclaw.format_settings import format_settings
from pyclaw.help import Help, install_help_extra
from pyclaw.io import CommandCompletionException
from pyclaw.llm import litellm
from pyclaw.repo import ANY_GIT_ERROR
from pyclaw.run_cmd import run_cmd
from pyclaw.scrape import Scraper, install_playwright
from pyclaw.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by pyclaw"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.pyclaw_commit_hashes:
            self.io.tool_error("The last commit was not made by pyclaw in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so pyclaw can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to pyclawignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use pyclaw.")

    def cmd_help(self, args):
        "Ask questions about pyclaw"
        ...
        from pyclaw.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of pyclaw was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from pyclaw.report import report_github_issue
