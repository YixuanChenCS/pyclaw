...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("pyclaw/website/assets/models-over-time.png")
        plt.savefig("pyclaw/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("pyclaw/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("pyclaw/website/_data/edit_leaderboard.yml")
